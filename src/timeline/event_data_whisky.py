...
WHISKY_TIMELINE_EVENTS: list[TimelineEvent] = [
    ...
    TimelineEvent(
        ...
        title_ko="John Walker Opens His Shop in Kilmarnock",
    ...
    TimelineEvent(
        ...
        title_ko="Square Bottle & 24° Angled Label",
    ...
    TimelineEvent(
        ...
        title_ko="The Striding Man Logo Is Born",
    ...
    TimelineEvent(
        ...
        title_ko="Red & Black Label Naming System",
    ...
    TimelineEvent(
        ...
        title_ko="Royal Warrant from King George V",
    ...
    TimelineEvent(
        ...
        title_ko="Red Label: World's #1 Scotch Whisky",
    ...
    TimelineEvent(
        ...
        title_ko="Blue Label Launch: Ultra-Premium Standard",
    ...
    TimelineEvent(
        ...
        title_ko="Diageo Formation: World's Largest Spirits Group",
    ...
    TimelineEvent(
        ...
        title_ko="'Keep Walking' Campaign: $2.2B Impact",
    ...
    TimelineEvent(
        ...
        title_ko="Robert Carlyle: The 6.5-Minute One-Take Legend",
    ...
    TimelineEvent(
        ...
        title_ko="Johnnie Walker House Seoul Opens",
    ...
    TimelineEvent(
        ...
        title_ko="Korean Highball Trend Goes Mainstream",
    ...
    TimelineEvent(
        ...
        title_ko="CL: Asian Face of Keep Walking",
    ...
    TimelineEvent(
        ...
        title_ko="4-Ambassador 'Cheers to My Success' Campaign",
    ...
    TimelineEvent(
        ...
        title_ko="Sabrina Carpenter: Next-Gen Global Partnership",
    ...
    TimelineEvent(
        ...
        title_ko="Space-Time AI Director: 200 Years of Whisky Intelligence",
